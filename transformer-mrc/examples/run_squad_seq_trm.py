...
from transformers import (WEIGHTS_NAME, BertConfig,
                                  BertForQuestionAnsweringSeqTrm, BertTokenizer,
                                  XLMConfig, XLMForQuestionAnswering,
                                  XLMTokenizer, XLNetConfig,
                                  XLNetForQuestionAnsweringTrm,
                                  XLNetTokenizer,
                                  DistilBertConfig, DistilBertForQuestionAnswering, DistilBertTokenizer,
                                  AlbertConfig, AlbertForQuestionAnsweringSeqTrm, AlbertTokenizer,
...
MODEL_CLASSES = {
    'bert': (BertConfig, BertForQuestionAnsweringSeqTrm, BertTokenizer),
    'xlnet': (XLNetConfig, XLNetForQuestionAnsweringTrm, XLNetTokenizer),
    'xlm': (XLMConfig, XLMForQuestionAnswering, XLMTokenizer),
    'distilbert': (DistilBertConfig, DistilBertForQuestionAnswering, DistilBertTokenizer),
    'albert': (AlbertConfig, AlbertForQuestionAnsweringSeqTrm, AlbertTokenizer),
}
