...
from transformers import (WEIGHTS_NAME, BertConfig,
                                  BertForQuestionAnsweringAVPoolBCEv3, BertTokenizer,
                                  XLMConfig, XLMForQuestionAnswering,
                                  XLMTokenizer, XLNetConfig,
                                  XLNetForQuestionAnswering,
                                  XLNetTokenizer,
                                  DistilBertConfig, DistilBertForQuestionAnswering, DistilBertTokenizer,
                                  AlbertConfig, AlbertForQuestionAnsweringAVPoolBCEv3, AlbertTokenizer,
...
MODEL_CLASSES = {
    'bert': (BertConfig, BertForQuestionAnsweringAVPoolBCEv3, BertTokenizer),
    'xlnet': (XLNetConfig, XLNetForQuestionAnswering, XLNetTokenizer),
    'xlm': (XLMConfig, XLMForQuestionAnswering, XLMTokenizer),
    'distilbert': (DistilBertConfig, DistilBertForQuestionAnswering, DistilBertTokenizer),
    'albert': (AlbertConfig, AlbertForQuestionAnsweringAVPoolBCEv3, AlbertTokenizer),
}
