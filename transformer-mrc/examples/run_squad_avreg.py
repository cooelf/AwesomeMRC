...
from transformers import (WEIGHTS_NAME, BertConfig,
                          BertForQuestionAnsweringAVReg, BertTokenizer,
                                  XLMConfig, XLMForQuestionAnswering,
                                  XLMTokenizer, XLNetConfig,
                                  XLNetForQuestionAnsweringReg,
                                  XLNetTokenizer,
                                  DistilBertConfig, DistilBertForQuestionAnswering, DistilBertTokenizer,
                                  AlbertConfig, AlbertForQuestionAnsweringAVReg, AlbertTokenizer,
...
MODEL_CLASSES = {
    'bert': (BertConfig, BertForQuestionAnsweringAVReg, BertTokenizer),
    'xlnet': (XLNetConfig, XLNetForQuestionAnsweringReg, XLNetTokenizer),
    'xlm': (XLMConfig, XLMForQuestionAnswering, XLMTokenizer),
    'distilbert': (DistilBertConfig, DistilBertForQuestionAnswering, DistilBertTokenizer),
    'albert': (AlbertConfig, AlbertForQuestionAnsweringAVReg, AlbertTokenizer),
}
