...
from transformers import (WEIGHTS_NAME, BertConfig,
                                  BertForQuestionAnsweringDep,BertForQuestionAnsweringDep2, BertTokenizer,
                                  XLMConfig, XLMForQuestionAnswering,
                                  XLMTokenizer, XLNetConfig,
                                  XLNetForQuestionAnswering,
                                  XLNetTokenizer,
                                  DistilBertConfig, DistilBertForQuestionAnswering, DistilBertTokenizer,
                                  AlbertConfig, AlbertForQuestionAnsweringDep, AlbertForQuestionAnsweringDep2, AlbertTokenizer,
...
MODEL_CLASSES = {
    'bert_dep': (BertConfig, BertForQuestionAnsweringDep, BertTokenizer),
    'bert_dep2': (BertConfig, BertForQuestionAnsweringDep2, BertTokenizer),
    'xlnet': (XLNetConfig, XLNetForQuestionAnswering, XLNetTokenizer),
    'xlm': (XLMConfig, XLMForQuestionAnswering, XLMTokenizer),
    'distilbert': (DistilBertConfig, DistilBertForQuestionAnswering, DistilBertTokenizer),
    'albert_dep': (AlbertConfig, AlbertForQuestionAnsweringDep, AlbertTokenizer),
    'albert_dep2': (AlbertConfig, AlbertForQuestionAnsweringDep2, AlbertTokenizer),
}
