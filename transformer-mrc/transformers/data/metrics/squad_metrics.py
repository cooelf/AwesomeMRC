...
def compute_predictions_logits_av(
    all_examples,
    all_features,
    all_results,
    n_best_size,
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        for (feature_index, feature) in enumerate(features):
            ...
            if version_2_with_negative:
                ...
                feature_null_score = bl * (result.start_logits[0] + result.end_logits[0]) + al * \
                                     (result.choice_logits[1]-result.choice_logits[0])
...
def compute_predictions_logits_choice(
    all_examples,
    all_features,
    all_results,
    n_best_size,
