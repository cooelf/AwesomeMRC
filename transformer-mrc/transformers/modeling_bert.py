...
class BertForQuestionAnsweringAVPoolBCE(BertPreTrainedModel):
    def __init__(self, config):
...
class BertForQuestionAnsweringAVPoolBCEv3(BertPreTrainedModel):
    def __init__(self, config):
...
class BertForQuestionAnsweringSeqTrm(BertPreTrainedModel):
    def __init__(self, config):
...
class BertForQuestionAnsweringSeqSC(BertPreTrainedModel):
    def __init__(self, config):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, pq_end_pos=None, position_ids=None, head_mask=None,
        ...
        query_sequence_output, context_sequence_output, query_attention_mask, context_attention_mask = \
            split_ques_context(sequence_output, pq_end_pos)
        sequence_output = self.attention(sequence_output, context_sequence_output, context_attention_mask) #这里context_sequence_output是question（第一个序列）
