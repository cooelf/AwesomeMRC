...
class BertCoAttention(nn.Module):
    ...
    # attention mask 对应context states
    def forward(self, context_states, query_states, attention_mask=None, head_mask=None, encoder_hidden_states=None, encoder_attention_mask=None):
        mixed_query_layer = self.query(context_states)
...
albert_att = BertCoAttention(config)
cq_biatt_output =albert_att(context_sequence_output, query_sequence_output, query_attention_mask)
